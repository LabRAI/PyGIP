...
_env_dev = os.getenv("PYGIP_DEVICE", None)
DEVICE = torch.device(_env_dev) if _env_dev else torch.device("cuda" if torch.cuda.is_available() else "cpu")
...
def main():
    ...
    # make outputs land inside the repo even when running from examples/
